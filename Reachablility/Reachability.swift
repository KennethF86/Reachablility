        ...
        private func showOverlayFullScreen(alertMessage: String, backgroundColor: UIColor, textColor: UIColor, textFont: UIFont, alertIcon: UIImage?) {
            ...
            if #available(iOS 13.0, *) {
                if let window = UIApplication.shared.currentWindow {
                    ...
                    let yourImage = alertIcon
                    imageView.image = yourImage!.withRenderingMode(.alwaysTemplate)
                    imageView.tintColor = textColor
                    imageView.contentMode = .center

                    //Text Label
                    textLabel.backgroundColor = .clear
                    textLabel.widthAnchor.constraint(equalToConstant: self.overlayView.frame.width).isActive = true
                    textLabel.heightAnchor.constraint(equalToConstant: 20.0).isActive = true
                    textLabel.textColor = textColor
                    textLabel.text  = alertMessage
                    ...
                    self.overlayView.addSubview(stackView)

                    //Constraints
                    stackView.centerXAnchor.constraint(equalTo: self.overlayView.centerXAnchor).isActive = true
                    stackView.centerYAnchor.constraint(equalTo: self.overlayView.centerYAnchor).isActive = true
